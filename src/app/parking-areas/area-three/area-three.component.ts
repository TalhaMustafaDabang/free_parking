...
@Component({
  selector: 'app-area-three',
  templateUrl: './area-three.component.html',
  styleUrls: ['./area-three.component.css']
})
export class AreaThreeComponent implements OnInit {
 ...
 admin: boolean;
  ...
  {
    this.parkings=this.dbs.parkingsThree;
...
bookParking(hour: string)
  {
    ...
    let booking: bookings={
      ...
      date:date,
      duration:"1HOUR",
      parking_area_name:"parking-area-3",
